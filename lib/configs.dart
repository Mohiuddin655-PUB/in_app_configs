...
const kDefaultConfigPath = "application";
...
class Configs extends Remote<ConfigsDelegate> {
  ...
  String _defaultPath = kDefaultConfigPath;
  ...
  static T? getByName<T extends Object?>(
    String name, {
    T? defaultValue,
    EnvironmentType? environment,
    PlatformType? platform,
    ...
    try {
      final raw = i._find(name, environment: environment, platform: platform);
